...
class TrafficViolationSeeder extends Seeder
{
    ...
    private array $violationsData = [
        ...
        ['citizen_index' => 2, 'vehicle_index' => 5, 'police_index' => 1, 'report_index' => 4, 'violation_type' => 'speeding', 'description' => 'شاحنة تتجاوز السرعة المحددة في منطقة أعمال على أوتستراد حلب.', 'fine_amount' => '75000.00', 'status' => 'canceled', 'issued_at' => '2026-02-10 09:00:00', 'due_date' => '2026-05-10'],
        ...
        ['citizen_index' => 3, 'vehicle_index' => null, 'police_index' => 2, 'report_index' => null, 'violation_type' => 'no_seatbelt', 'description' => 'ركاب المقعد الخلفي بدون حزام أمان خلال توقف روتيني في طرطوس.', 'fine_amount' => '10000.00', 'status' => 'canceled', 'issued_at' => '2026-03-25 12:00:00', 'due_date' => '2026-06-25'],
